...
for (let r = 0; r < 6; r++) {
    ...
    for (let c = 0; c < 7; c++) {
        ...
        xml += `\n                <TextView android:id="@+id/cal_cell_num_${cid}" android:layout_width="match_parent" android:layout_height="wrap_content" android:gravity="center" android:textColor="#ffffff" android:textSize="8.5sp" android:textStyle="bold" />`;
        xml += `\n                <TextView android:id="@+id/cal_cell_ev1_${cid}" android:layout_width="match_parent" android:layout_height="wrap_content" android:gravity="left" android:textColor="#ffffff" android:textSize="6.5sp" android:textStyle="bold" android:maxLines="1" android:paddingLeft="1dp" android:paddingRight="1dp" android:singleLine="true" android:ellipsize="end" />`;
